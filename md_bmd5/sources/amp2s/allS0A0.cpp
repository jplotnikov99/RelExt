...
double DT::S0A0VMvm(const double &cos_t, const double &s){
	...
	return (2*(t*u - (s + t + u)* (MA0*MA0) +  (MA0*MA0*MA0*MA0))* (token2*token2))/(9.*(-t +  (Mchi0*Mchi0))*(-u +  (Mchi0*Mchi0))) + ((t*u - (s + t + u)* (MA0*MA0) +  (MA0*MA0*MA0*MA0))* (token2*token2))/(9.* (( (Mchi0*Mchi0) - t)*( (Mchi0*Mchi0) - t))) + ((t*u - (s + t + u)* (MA0*MA0) +  (MA0*MA0*MA0*MA0))* (token2*token2))/(9.* (( (Mchi0*Mchi0) - u)*( (Mchi0*Mchi0) - u)));
}
