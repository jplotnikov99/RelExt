...
double DT::S0pQVMu(const double &cos_t, const double &s){
	...
	return ((48000000*(t*u - (s + t + u)* (MphiQ*MphiQ) +  (MphiQ*MphiQ*MphiQ*MphiQ) + (s + u)* (MU*MU) -  (MU*MU*MU*MU))* (token3*token3)* (token36*token36)* (token40*token40)* (token51*token51))/ (( (Mchi0*Mchi0) - 1000*t)*( (Mchi0*Mchi0) - 1000*t)));
}
double DT::S0pQVMc(const double &cos_t, const double &s){
	...
	return ((48000000*(t*u + (s + u)* (MC*MC) -  (MC*MC*MC*MC) - (s + t + u)* (MphiQ*MphiQ) +  (MphiQ*MphiQ*MphiQ*MphiQ))* (token3*token3)* (token36*token36)* (token44*token44)* (token51*token51))/ (( (Mchi0*Mchi0) - 1000*t)*( (Mchi0*Mchi0) - 1000*t)));
}
double DT::S0pQVMt(const double &cos_t, const double &s){
	...
	return ((48000000*(t*u - (s + t + u)* (MphiQ*MphiQ) +  (MphiQ*MphiQ*MphiQ*MphiQ) + (s + u)* (MT*MT) -  (MT*MT*MT*MT))* (token3*token3)* (token36*token36)* (token48*token48)* (token51*token51))/ (( (Mchi0*Mchi0) - 1000*t)*( (Mchi0*Mchi0) - 1000*t)));
}
double DT::S0pQMUs(const double &cos_t, const double &s){
	...
	return ((-48000000*(-(t*u) + (s + t + u)* (MphiQ*MphiQ) -  (MphiQ*MphiQ*MphiQ*MphiQ) - s* (MS*MS) - u* (MS*MS) +  (MMU*MMU)*(t - 2* (MphiQ*MphiQ) + 2* (MS*MS)) +  (MS*MS*MS*MS))* (token1*token1)* (token33*token33)* (token36*token36)* (token51*token51))/ (( (MchiM*MchiM) - 1000*t)*( (MchiM*MchiM) - 1000*t)));
}
double DT::S0pQMUb(const double &cos_t, const double &s){
	...
	return ((-48000000*(-(t*u) +  (MB*MB*MB*MB) +  (MB*MB)*(-s - u + 2* (MMU*MMU)) +  (MMU*MMU)*(t - 2* (MphiQ*MphiQ)) + s* (MphiQ*MphiQ) + t* (MphiQ*MphiQ) + u* (MphiQ*MphiQ) -  (MphiQ*MphiQ*MphiQ*MphiQ))* (token1*token1)* (token32*token32)* (token36*token36)* (token51*token51))/ (( (MchiM*MchiM) - 1000*t)*( (MchiM*MchiM) - 1000*t)));
}
