...
double DT::A0pQVMu(const double &cos_t, const double &s){
	...
	return ((3000000*(t*u - (s + t + u)* (MphiQ*MphiQ) +  (MphiQ*MphiQ*MphiQ*MphiQ) + (s + u)* (MU*MU) -  (MU*MU*MU*MU))* (token36*token36)* (token40*token40)* (token51*token51))/(-2000000*t* (Mchi0*Mchi0) + 1000001* (Mchi0*Mchi0*Mchi0*Mchi0) + 1000000* (t*t)));
}
double DT::A0pQVMc(const double &cos_t, const double &s){
	...
	return ((3000000*(t*u + (s + u)* (MC*MC) -  (MC*MC*MC*MC) - (s + t + u)* (MphiQ*MphiQ) +  (MphiQ*MphiQ*MphiQ*MphiQ))* (token36*token36)* (token44*token44)* (token51*token51))/(-2000000*t* (Mchi0*Mchi0) + 1000001* (Mchi0*Mchi0*Mchi0*Mchi0) + 1000000* (t*t)));
}
double DT::A0pQVMt(const double &cos_t, const double &s){
	...
	return ((3000000*(t*u - (s + t + u)* (MphiQ*MphiQ) +  (MphiQ*MphiQ*MphiQ*MphiQ) + (s + u)* (MT*MT) -  (MT*MT*MT*MT))* (token36*token36)* (token48*token48)* (token51*token51))/(-2000000*t* (Mchi0*Mchi0) + 1000001* (Mchi0*Mchi0*Mchi0*Mchi0) + 1000000* (t*t)));
}
double DT::A0pQMUs(const double &cos_t, const double &s){
	...
	return ((-3000000*(-(t*u) + (s + t + u)* (MphiQ*MphiQ) -  (MphiQ*MphiQ*MphiQ*MphiQ) - s* (MS*MS) - u* (MS*MS) +  (MMU*MMU)*(t - 2* (MphiQ*MphiQ) + 2* (MS*MS)) +  (MS*MS*MS*MS))* (token33*token33)* (token36*token36)* (token51*token51))/(-2000000*t* (MchiM*MchiM) + 1000001* (MchiM*MchiM*MchiM*MchiM) + 1000000* (t*t)));
}
double DT::A0pQMUb(const double &cos_t, const double &s){
	...
	return ((3000000*(t*u -  (MB*MB*MB*MB) +  (MB*MB)*(s + u - 2* (MMU*MMU)) - s* (MphiQ*MphiQ) - t* (MphiQ*MphiQ) - u* (MphiQ*MphiQ) +  (MMU*MMU)*(-t + 2* (MphiQ*MphiQ)) +  (MphiQ*MphiQ*MphiQ*MphiQ))* (token32*token32)* (token36*token36)* (token51*token51))/(-2000000*t* (MchiM*MchiM) + 1000001* (MchiM*MchiM*MchiM*MchiM) + 1000000* (t*t)));
}
