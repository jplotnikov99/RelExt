...
double DT::wwH(const double QCDaS){
	...
	std::vector<ParticleType> type1( { scalar, pseudoscalar, pseudoscalar, scalar, z_boson, w_boson, lepton, lepton, lepton, quark, c_quark, t_quark, quark, s_quark, b_quark, gluon } );
	std::vector<ParticleType> type2( { scalar, pseudoscalar, pseudoscalar, scalar, z_boson, w_boson, lepton, lepton, lepton, quark, c_quark, t_quark, quark, s_quark, b_quark, gluon } );
