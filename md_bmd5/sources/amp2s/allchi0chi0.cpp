...
double DT::chi0CHI0VEve(const double &cos_t, const double &s){
	double t = (-s + cos_t*sqrt(s)*sqrt(s - 4* (Mchi0*Mchi0)))/2. +  (Mchi0*Mchi0);
	double u = -s - t + Mchi0*Mchi0 + Mchi0*Mchi0 + 0*0 + 0*0;
	return (16* (token43*token43)* (token47*token47)* (token7*token7)*(2*(s - t - u)* (Mchi0*Mchi0) + 2* (Mchi0*Mchi0*Mchi0*Mchi0) +  (t*t) +  (u*u)))/( (token44*token44)* (token49*token49)* (token50*token50)*( (MZ*MZ*MZ*MZ) +  (s*s) +  (MZ*MZ)*(-2*s +  (WZ*WZ))));
}
double DT::chi0CHI0VMvm(const double &cos_t, const double &s){
	double t = (-s + cos_t*sqrt(s)*sqrt(s - 4* (Mchi0*Mchi0)))/2. +  (Mchi0*Mchi0);
	double u = -s - t + Mchi0*Mchi0 + Mchi0*Mchi0 + 0*0 + 0*0;
	return (-32* (token1*token1)* (token2*token2)* (( (Mchi0*Mchi0) - u)*( (Mchi0*Mchi0) - u)))/((-u +  (MA0*MA0))*(u -  (MS0*MS0))* (token4*token4)) + (16* (token1*token1)* (token2*token2)* (( (Mchi0*Mchi0) - u)*( (Mchi0*Mchi0) - u)))/( (token4*token4)* (( (MA0*MA0) - u)*( (MA0*MA0) - u))) + (16* (token1*token1)* (token2*token2)* (( (Mchi0*Mchi0) - u)*( (Mchi0*Mchi0) - u)))/( (token4*token4)* (( (MS0*MS0) - u)*( (MS0*MS0) - u))) + (32*token1*token2*token43*token47*token7*(-s +  (MZ*MZ))*((s - 2*u)* (Mchi0*Mchi0) +  (Mchi0*Mchi0*Mchi0*Mchi0) +  (u*u)))/(token4*token44*token49*token50*(-u +  (MA0*MA0))*( (MZ*MZ*MZ*MZ) +  (s*s) +  (MZ*MZ)*(-2*s +  (WZ*WZ)))) + (32*token1*token2*token43*token47*token7*(-s +  (MZ*MZ))*((s - 2*u)* (Mchi0*Mchi0) +  (Mchi0*Mchi0*Mchi0*Mchi0) +  (u*u)))/(token4*token44*token49*token50*(-u +  (MS0*MS0))*( (MZ*MZ*MZ*MZ) +  (s*s) +  (MZ*MZ)*(-2*s +  (WZ*WZ)))) + (16* (token43*token43)* (token47*token47)* (token7*token7)*(2*(s - t - u)* (Mchi0*Mchi0) + 2* (Mchi0*Mchi0*Mchi0*Mchi0) +  (t*t) +  (u*u)))/( (token44*token44)* (token49*token49)* (token50*token50)*( (MZ*MZ*MZ*MZ) +  (s*s) +  (MZ*MZ)*(-2*s +  (WZ*WZ))));
}
