...
double DT::A0A0HH(const double &cos_t, const double &s){
	...
	return 0.5*((2*token5*token74*token80*token82)/(t -  (MA0*MA0)/1000.) + (2*token5*token74*token80*token82)/(u -  (MA0*MA0)/1000.) +  (token80*token80) + (2* (token5*token5)* (token74*token74)* (token82*token82))/((t -  (MA0*MA0)/1000.)*(u -  (MA0*MA0)/1000.)) + ( (token5*token5)* (token74*token74)* (token82*token82))/ ((-0.001* (MA0*MA0) + t)*(-0.001* (MA0*MA0) + t)) + ( (token5*token5)* (token74*token74)* (token82*token82))/ ((-0.001* (MA0*MA0) + u)*(-0.001* (MA0*MA0) + u)) + (2000*token5*token73*token80*token81*token82*(-s +  (MH*MH))* (token74*token74))/((-1000*t +  (MA0*MA0))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token5*token73*token80*token81*token82*(-s +  (MH*MH))* (token74*token74))/((-1000*u +  (MA0*MA0))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2*token73*token74*token81*(s -  (MH*MH))* (token80*token80))/( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH))) + ( (token73*token73)* (token74*token74)* (token80*token80)* (token81*token81))/( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH))));
}
...
double DT::A0A0VMvm(const double &cos_t, const double &s){
	...
	return ((-32000000*(t*u - (s + t + u)* (MA0*MA0) +  (MA0*MA0*MA0*MA0))* (token2*token2)* (token54*token54))/((-1000*t +  (Mchi0*Mchi0))*(-1000*u +  (Mchi0*Mchi0))) + (16000000*(t*u - (s + t + u)* (MA0*MA0) +  (MA0*MA0*MA0*MA0))* (token2*token2)* (token54*token54))/ (( (Mchi0*Mchi0) - 1000*t)*( (Mchi0*Mchi0) - 1000*t)) + (16000000*(t*u - (s + t + u)* (MA0*MA0) +  (MA0*MA0*MA0*MA0))* (token2*token2)* (token54*token54))/ (( (Mchi0*Mchi0) - 1000*u)*( (Mchi0*Mchi0) - 1000*u)));
}
...
double DT::A0A0MUmu(const double &cos_t, const double &s){
	...
	return ((-32000000*(t*u +  (MA0*MA0*MA0*MA0) +  (MA0*MA0)*(-s - t - u + 2* (MMU*MMU)) +  (MMU*MMU*MMU*MMU))* (token2*token2)* (token54*token54))/((-1000*t +  (MchiM*MchiM))*(-1000*u +  (MchiM*MchiM))) + (16000000*(t*u +  (MA0*MA0*MA0*MA0) + (s - t + u)* (MMU*MMU) +  (MA0*MA0)*(-s - t - u + 2* (MMU*MMU)) - 3* (MMU*MMU*MMU*MMU))* (token2*token2)* (token54*token54))/ (( (MchiM*MchiM) - 1000*t)*( (MchiM*MchiM) - 1000*t)) + (16000000*(t*u +  (MA0*MA0*MA0*MA0) + (s + t - u)* (MMU*MMU) +  (MA0*MA0)*(-s - t - u + 2* (MMU*MMU)) - 3* (MMU*MMU*MMU*MMU))* (token2*token2)* (token54*token54))/ (( (MchiM*MchiM) - 1000*u)*( (MchiM*MchiM) - 1000*u)) + (8000*MMU*token10*token2*token50*token54*token80*(-s +  (MH*MH))*(-s + t - u + 4* (MMU*MMU)))/(token35*(-1000*t +  (MchiM*MchiM))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (8000*MMU*token10*token2*token50*token54*token80*(-s +  (MH*MH))*(-s - t + u + 4* (MMU*MMU)))/(token35*(-1000*u +  (MchiM*MchiM))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2*(s - 4* (MMU*MMU))* (token10*token10)* (token50*token50)* (token80*token80))/( (token35*token35)*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))));
}
