...
double DT::pQPQHHfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MphiQ,MphiQ,MH,MH)*pQPQHH(cos_t, s);
}
...
double DT::pQPQAAfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MphiQ,MphiQ,0,0)*pQPQAA(cos_t, s);
}
...
double DT::pQPQZZfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MphiQ,MphiQ,MZ,MZ)*pQPQZZ(cos_t, s);
}
...
double DT::pQPQGGfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MphiQ,MphiQ,0,0)*pQPQGG(cos_t, s);
}
