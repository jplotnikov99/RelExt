...
double DT::wS1HS1(){
   ...
   alpha) + svev*sin(alpha))))/(16.*Pi* (MS1*MS1*MS1)* (svev*svev)* (vev*vev))
...
double DT::wS1ZZ(){
   ...
   (MZ*MZ))*( (MS1*MS1*MS1*MS1) - 4* (MS1*MS1)* (MZ*MZ) + 12* (MZ*MZ*MZ*MZ))*\
 
   (vev*vev)* (( (cw*cw) +  (sw*sw))*( (cw*cw) +  (sw*sw))*( (cw*cw) + \
 
   (sw*sw))*( (cw*cw) +  (sw*sw)))* (sin(alpha)*sin(alpha)))/(256.*Pi*\
 
   (cw*cw*cw*cw)* (MS1*MS1*MS1)* (MZ*MZ*MZ*MZ)* (sw*sw*sw*sw));
	 }
	 else{ return 0; }
...
double DT::wS1wW(){
   ...
   (MS1*MS1*MS1*MS1) - 4* (MS1*MS1)* (MW*MW) + 12* (MW*MW*MW*MW))* (vev*vev)*\
 
   (sin(alpha)*sin(alpha)))/(256.*Pi* (MS1*MS1*MS1)* (MW*MW*MW*MW)*\
...
double DT::wS1Ee(){
	 if(heaviDecays(MS1,Me,Me)){
		 return ((-4* (Me*Me) +  (MS1*MS1))*sqrt(-4* (Me*Me)* (MS1*MS1) + \
 
   (MS1*MS1*MS1*MS1))* (ye*ye)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1MUmu(){
	 if(heaviDecays(MS1,MMU,MMU)){
		 return ((-4* (MMU*MMU) +  (MS1*MS1))*sqrt(-4* (MMU*MMU)* (MS1*MS1) + \
 
   (MS1*MS1*MS1*MS1))* (ym*ym)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1TAta(){
	 if(heaviDecays(MS1,MTA,MTA)){
		 return (( (MS1*MS1) - 4* (MTA*MTA))*sqrt( (MS1*MS1*MS1*MS1) - 4*\
 
   (MS1*MS1)* (MTA*MTA))* (ytau*ytau)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1Uu(){
	 if(heaviDecays(MS1,MU,MU)){
		 return (3*( (MS1*MS1) - 4* (MU*MU))*sqrt( (MS1*MS1*MS1*MS1) - 4*\
 
   (MS1*MS1)* (MU*MU))* (yup*yup)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1Cc(){
	 if(heaviDecays(MS1,MC,MC)){
		 return (3*(-4* (MC*MC) +  (MS1*MS1))*sqrt(-4* (MC*MC)* (MS1*MS1) + \
 
   (MS1*MS1*MS1*MS1))* (yc*yc)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1Tt(){
	 if(heaviDecays(MS1,MT,MT)){
		 return (3*( (MS1*MS1) - 4* (MT*MT))*sqrt( (MS1*MS1*MS1*MS1) - 4*\
 
   (MS1*MS1)* (MT*MT))* (yt*yt)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1Dd(){
	 if(heaviDecays(MS1,MD,MD)){
		 return (3*(-4* (MD*MD) +  (MS1*MS1))*sqrt(-4* (MD*MD)* (MS1*MS1) + \
 
   (MS1*MS1*MS1*MS1))* (ydo*ydo)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1Ss(){
	 if(heaviDecays(MS1,MS,MS)){
		 return (3*(-4* (MS*MS) +  (MS1*MS1))*sqrt(-4* (MS*MS)* (MS1*MS1) + \
 
   (MS1*MS1*MS1*MS1))* (ys*ys)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
...
double DT::wS1Bb(){
	 if(heaviDecays(MS1,MB,MB)){
		 return (3*(-4* (MB*MB) +  (MS1*MS1))*sqrt(-4* (MB*MB)* (MS1*MS1) + \
 
   (MS1*MS1*MS1*MS1))* (yb*yb)* (sin(alpha)*sin(alpha)))/(16.*Pi*\
