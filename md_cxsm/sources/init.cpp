...
namespace DT{
	...
	{
		if (nlo){
			ADDCHANNEL("A1,A1,H,H",A1A1HHNLO, A1A1HHNLOfl)
			ADDCHANNEL("A1,A1,H,S1",A1A1HS1NLO, A1A1HS1NLOfl)
			ADDCHANNEL("A1,A1,S1,S1",A1A1S1S1NLO, A1A1S1S1NLOfl)
			ADDCHANNEL("A1,A1,Z,Z",A1A1ZZNLO, A1A1ZZNLOfl)
			ADDCHANNEL("A1,A1,w,W",A1A1wWNLO, A1A1wWNLOfl)
			// ADDCHANNEL("A1,A1,E,e",A1A1Ee, A1A1Eefl)
			// ADDCHANNEL("A1,A1,MU,mu",A1A1MUmu, A1A1MUmufl)
			ADDCHANNEL("A1,A1,TA,ta",A1A1TAtaNLO, A1A1TAtaNLOfl)
			// ADDCHANNEL("A1,A1,U,u",A1A1Uu, A1A1Uufl)
			// ADDCHANNEL("A1,A1,C,c",A1A1Cc, A1A1Ccfl)
			ADDCHANNEL("A1,A1,T,t",A1A1TtNLO, A1A1TtNLOfl)
			// ADDCHANNEL("A1,A1,D,d",A1A1Dd, A1A1Ddfl)
			// ADDCHANNEL("A1,A1,S,s",A1A1Ss, A1A1Ssfl)
			ADDCHANNEL("A1,A1,B,b",A1A1BbNLO, A1A1BbNLOfl)
		}
		else {
