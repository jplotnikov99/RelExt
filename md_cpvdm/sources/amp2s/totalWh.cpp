...
double DT::whH1H2(){
	 if(heaviDecays(mHsm,mH1,mH2)){
      ...
      L5)*RR1x1*RR2x1*v + (L3 + L4 - L5)*RR1x2*RR2x2*v +\
 
      RR1x3*(-(RR2x2*Timag) + RR2x1*Treal + L7*RR2x3*v))))/(16.*Pi*\
...
double DT::whH1H3(){
	 if(heaviDecays(mHsm,mH1,mH3)){
      ...
      L5)*RR1x1*RR3x1*v + (L3 + L4 - L5)*RR1x2*RR3x2*v +\
 
      RR1x3*(-(RR3x2*Timag) + RR3x1*Treal + L7*RR3x3*v))))/(16.*Pi*\
...
double DT::whH2H3(){
	 if(heaviDecays(mHsm,mH2,mH3)){
      ...
      L5)*RR2x1*RR3x1*v + (L3 + L4 - L5)*RR2x2*RR3x2*v +\
 
      RR2x3*(-(RR3x2*Timag) + RR3x1*Treal + L7*RR3x3*v))))/(16.*Pi*\
