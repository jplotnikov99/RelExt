...
double DT::wZHCHc(){
   ...
   (MZ*MZ*MZ*MZ))* (( (CW*CW) -  (SW*SW))*( (CW*CW) -  (SW*SW))))/(192.*Pi*\
...
double DT::wZVEve(){
   ...
   +  (MZ*MZ*MZ*MZ))* (( (CW*CW) +  (SW*SW))*( (CW*CW) +  (SW*SW))))/(96.*Pi*\
...
double DT::wZEe(){
   ...
   (CW*CW*CW*CW)*(- (Me*Me) +  (MZ*MZ)) - 2* (CW*CW)*(5* (Me*Me) +  (MZ*MZ))*\
 
   (SW*SW) + (7* (Me*Me) + 5* (MZ*MZ))* (SW*SW*SW*SW)))/(96.*Pi* (CW*CW)*\
...
double DT::wZMm(){
   ...
   (CW*CW*CW*CW)*(- (MM*MM) +  (MZ*MZ)) - 2* (CW*CW)*(5* (MM*MM) +  (MZ*MZ))*\
 
   (SW*SW) + (7* (MM*MM) + 5* (MZ*MZ))* (SW*SW*SW*SW)))/(96.*Pi* (CW*CW)*\
...
double DT::wZTAta(){
   ...
   (MZ*MZ))* (SW*SW) + (7* (MTA*MTA) + 5* (MZ*MZ))* (SW*SW*SW*SW)))/(96.*Pi*\
...
double DT::wZUu(){
   ...
   (MZ*MZ))* (SW*SW) + (7* (MU*MU) + 17* (MZ*MZ))* (SW*SW*SW*SW)))/(288.*Pi*\
...
double DT::wZCc(){
   ...
   (MZ*MZ))* (SW*SW) + (7* (MC*MC) + 17* (MZ*MZ))* (SW*SW*SW*SW)))/(288.*Pi*\
...
double DT::wZTt(){
   ...
   (MZ*MZ))* (SW*SW) + (7* (MT*MT) + 17* (MZ*MZ))* (SW*SW*SW*SW)))/(288.*Pi*\
...
double DT::wZDd(){
   ...
   (MZ*MZ))* (SW*SW) + (-17* (MD*MD) + 5* (MZ*MZ))* (SW*SW*SW*SW)))/(288.*Pi*\
...
double DT::wZSs(){
   ...
   (MZ*MZ))* (SW*SW) + (-17* (MS*MS) + 5* (MZ*MZ))* (SW*SW*SW*SW)))/(288.*Pi*\
...
double DT::wZBb(){
   ...
   (MZ*MZ))* (SW*SW) + (-17* (MB*MB) + 5* (MZ*MZ))* (SW*SW*SW*SW)))/(288.*Pi*\
