...
double DT::H1H1hh(double cos_t, double s){
...
double DT::H1H1hZ(double cos_t, double s){
...
double DT::H1H1ZZ(double cos_t, double s){
double t =  (mH1*mH1) + (-s + cos_t*sqrt(s - 4* (mH1*mH1))*sqrt(s - 4*\
...
double DT::H1H1wW(double cos_t, double s){
double t =  (mH1*mH1) + (-s + cos_t*sqrt(s - 4* (mH1*mH1))*sqrt(s - 4*\
...
double DT::H1H1Ee(double cos_t, double s){
...
double DT::H1H1Mm(double cos_t, double s){
...
double DT::H1H1TAta(double cos_t, double s){
...
double DT::H1H1Uu(double cos_t, double s){
...
double DT::H1H1Cc(double cos_t, double s){
...
double DT::H1H1Tt(double cos_t, double s){
...
double DT::H1H1Dd(double cos_t, double s){
...
double DT::H1H1Ss(double cos_t, double s){
...
double DT::H1H1Bb(double cos_t, double s){
