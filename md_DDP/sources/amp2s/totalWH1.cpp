...
double DT::wwH1(const double QCDaS){
	...
	std::vector<double> coupling2( {0.5*(9* (MH1*MH1*MH1*MH1)* ((vs* (cos( aDM)*cos( aDM)*cos( aDM)) + v* (sin(aDM)*sin(aDM)*sin(aDM)))*(vs* (cos( aDM)*cos( aDM)*cos( aDM)) + v* (sin(aDM)*sin(aDM)*sin(aDM)))))/( (v*v)* (vs*vs)), ( (cos( aDM)*cos( aDM))* ((2* (MH1*MH1) +  (MH2*MH2))*(2* (MH1*MH1) +  (MH2*MH2)))* (sin(aDM)*sin(aDM))* ((vs*cos( aDM) - v*sin(aDM))*(vs*cos( aDM) - v*sin(aDM))))/( (v*v)* (vs*vs)), 0.5*( (cos( aDM)*cos( aDM))* ((- (MH1*MH1) - 2* (MH2*MH2))*(- (MH1*MH1) - 2* (MH2*MH2)))* (sin(aDM)*sin(aDM))* ((v*cos( aDM) + vs*sin(aDM))*(v*cos( aDM) + vs*sin(aDM))))/( (v*v)* (vs*vs)), 0.5* ((-2* (m22*m22)*cos( aDM) + 2* (MH3*MH3)*cos( aDM) - lam8* (vs*vs)*cos( aDM) + lam8*v*vs*sin(aDM))*(-2* (m22*m22)*cos( aDM) + 2* (MH3*MH3)*cos( aDM) - lam8* (vs*vs)*cos( aDM) + lam8*v*vs*sin(aDM)))/ (v*v), 0.5* ((-2* (m22*m22)*cos( aDM) + 2* (MA0*MA0)*cos( aDM) - lam8* (vs*vs)*cos( aDM) + lam8*v*vs*sin(aDM))*(-2* (m22*m22)*cos( aDM) + 2* (MA0*MA0)*cos( aDM) - lam8* (vs*vs)*cos( aDM) + lam8*v*vs*sin(aDM)))/ (v*v),  ((-2* (m22*m22)*cos( aDM) + 2* (MHch*MHch)*cos( aDM) - lam8* (vs*vs)*cos( aDM) + lam8*v*vs*sin(aDM))*(-2* (m22*m22)*cos( aDM) + 2* (MHch*MHch)*cos( aDM) - lam8* (vs*vs)*cos( aDM) + lam8*v*vs*sin(aDM)))/ (v*v), 0.5*( (EL*EL*EL*EL)* (v*v)* (cos( aDM)*cos( aDM))* (( (CW*CW) +  (SW*SW))*( (CW*CW) +  (SW*SW))*( (CW*CW) +  (SW*SW))*( (CW*CW) +  (SW*SW))))/(4.* (CW*CW*CW*CW)* (SW*SW*SW*SW)), ( (EL*EL*EL*EL)* (v*v)* (cos( aDM)*cos( aDM)))/(4.* (SW*SW*SW*SW)), 0.5* (GH*GH), ( (Me*Me)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MM*MM)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MTA*MTA)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MU*MU)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MC*MC)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MT*MT)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MD*MD)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MS*MS)* (cos( aDM)*cos( aDM)))/ (v*v), ( (MB*MB)* (cos( aDM)*cos( aDM)))/ (v*v), 0.5*( (MT*MT)* (cos( aDM)*cos( aDM)))/ (v*v) } );
