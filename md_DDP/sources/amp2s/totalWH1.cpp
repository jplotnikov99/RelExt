...
double DT::wwH1(const double QCDaS){
	...
	std::vector<ParticleType> type1( { scalar, scalar, scalar, scalar, scalar, scalar, z_boson, w_boson, massless_vector_boson, lepton, lepton, lepton, quark, c_quark, t_quark, quark, s_quark, b_quark, gluon } );
	std::vector<ParticleType> type2( { scalar, scalar, scalar, scalar, scalar, scalar, z_boson, w_boson, massless_vector_boson, lepton, lepton, lepton, quark, c_quark, t_quark, quark, s_quark, b_quark, gluon } );
