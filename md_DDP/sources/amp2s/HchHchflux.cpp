...
double DT::HchHCHH1H1fl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MHch,MHch,MH1,MH1)*HchHCHH1H1(cos_t, s);
}
...
double DT::HchHCHH2H2fl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MHch,MHch,MH2,MH2)*HchHCHH2H2(cos_t, s);
}
...
double DT::HchHCHAAfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MHch,MHch,0,0)*HchHCHAA(cos_t, s);
}
...
double DT::HchHCHZZfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MHch,MHch,MZ,MZ)*HchHCHZZ(cos_t, s);
}
double DT::HchHCHwWfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MHch,MHch,MW,MW)*HchHCHwW(cos_t, s);
...
double DT::HchHCHGGfl(const double &cos_t, const double &s){
	using namespace PAR;
	return 2*flux(s, MHch,MHch,0,0)*HchHCHGG(cos_t, s);
}
