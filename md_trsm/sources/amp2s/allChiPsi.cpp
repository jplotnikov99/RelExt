...
double DT::ChiPsiHH(const double &cos_t, const double &s){
	...
	return 0.5*((token32*token34*token4*token5*token6)/(token16*(t -  (MChi*MChi)/1000.)) + (token32*token34*token4*token5*token6)/(token16*(u -  (MChi*MChi)/1000.)) + (token32*token34*token35*token4*token6)/(token16*(t -  (MPsi*MPsi)/1000.)) + (token32*token34*token35*token4*token6)/(token16*(u -  (MPsi*MPsi)/1000.)) +  (token32*token32)/4. + (2*token35*token5* (token34*token34)* (token4*token4)* (token6*token6))/((t -  (MChi*MChi)/1000.)*(t -  (MPsi*MPsi)/1000.)* (token16*token16)) + (2*token35*token5* (token34*token34)* (token4*token4)* (token6*token6))/((u -  (MChi*MChi)/1000.)*(t -  (MPsi*MPsi)/1000.)* (token16*token16)) + (2*token35*token5* (token34*token34)* (token4*token4)* (token6*token6))/((t -  (MChi*MChi)/1000.)*(u -  (MPsi*MPsi)/1000.)* (token16*token16)) + (2*token35*token5* (token34*token34)* (token4*token4)* (token6*token6))/((u -  (MChi*MChi)/1000.)*(u -  (MPsi*MPsi)/1000.)* (token16*token16)) + (2* (token34*token34)* (token35*token35)* (token4*token4)* (token6*token6))/((t -  (MPsi*MPsi)/1000.)*(u -  (MPsi*MPsi)/1000.)* (token16*token16)) + ( (token34*token34)* (token35*token35)* (token4*token4)* (token6*token6))/( ((-0.001* (MPsi*MPsi) + t)*(-0.001* (MPsi*MPsi) + t))* (token16*token16)) + (2* (token34*token34)* (token4*token4)* (token5*token5)* (token6*token6))/((t -  (MChi*MChi)/1000.)*(u -  (MChi*MChi)/1000.)* (token16*token16)) + ( (token34*token34)* (token4*token4)* (token5*token5)* (token6*token6))/( ((-0.001* (MChi*MChi) + t)*(-0.001* (MChi*MChi) + t))* (token16*token16)) + ( (token34*token34)* (token4*token4)* (token5*token5)* (token6*token6))/( (token16*token16)* ((-0.001* (MChi*MChi) + u)*(-0.001* (MChi*MChi) + u))) + ( (token34*token34)* (token35*token35)* (token4*token4)* (token6*token6))/( (token16*token16)* ((-0.001* (MPsi*MPsi) + u)*(-0.001* (MPsi*MPsi) + u))) + (token3*token32*token33*token34*token4*(s -  (MH*MH)))/( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH))) + (2000*token3*token33*token5*token6*(-s +  (MH*MH))* (token34*token34)* (token4*token4))/(token16*(-1000*t +  (MChi*MChi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token3*token33*token5*token6*(-s +  (MH*MH))* (token34*token34)* (token4*token4))/(token16*(-1000*u +  (MChi*MChi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token3*token33*token35*token6*(-s +  (MH*MH))* (token34*token34)* (token4*token4))/(token16*(-1000*t +  (MPsi*MPsi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token3*token33*token35*token6*(-s +  (MH*MH))* (token34*token34)* (token4*token4))/(token16*(-1000*u +  (MPsi*MPsi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + ( (token3*token3)* (token33*token33)* (token34*token34)* (token4*token4))/( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH))));
}
