...
double DT::ChiChiHH(const double &cos_t, const double &s){
	...
	return 0.5*((2*token1*token4*token6*token7)/(t -  (MChi*MChi)/1000.) + (2*token1*token4*token6*token7)/(u -  (MChi*MChi)/1000.) + (2*token1*token4*token6*token8)/(token10*(t -  (MPsi*MPsi)/1000.)) + (2*token1*token4*token6*token8)/(token10*(u -  (MPsi*MPsi)/1000.)) +  (token1*token1) + (2*token7*token8* (token4*token4)* (token6*token6))/(token10*(t -  (MChi*MChi)/1000.)*(t -  (MPsi*MPsi)/1000.)) + (2*token7*token8* (token4*token4)* (token6*token6))/(token10*(u -  (MChi*MChi)/1000.)*(t -  (MPsi*MPsi)/1000.)) + (2*token7*token8* (token4*token4)* (token6*token6))/(token10*(t -  (MChi*MChi)/1000.)*(u -  (MPsi*MPsi)/1000.)) + (2*token7*token8* (token4*token4)* (token6*token6))/(token10*(u -  (MChi*MChi)/1000.)*(u -  (MPsi*MPsi)/1000.)) + (2* (token4*token4)* (token6*token6)* (token7*token7))/((t -  (MChi*MChi)/1000.)*(u -  (MChi*MChi)/1000.)) + ( (token4*token4)* (token6*token6)* (token7*token7))/ ((-0.001* (MChi*MChi) + t)*(-0.001* (MChi*MChi) + t)) + (2* (token4*token4)* (token6*token6)* (token8*token8))/((t -  (MPsi*MPsi)/1000.)*(u -  (MPsi*MPsi)/1000.)* (token10*token10)) + ( (token4*token4)* (token6*token6)* (token8*token8))/( ((-0.001* (MPsi*MPsi) + t)*(-0.001* (MPsi*MPsi) + t))* (token10*token10)) + ( (token4*token4)* (token6*token6)* (token7*token7))/ ((-0.001* (MChi*MChi) + u)*(-0.001* (MChi*MChi) + u)) + ( (token4*token4)* (token6*token6)* (token8*token8))/( (token10*token10)* ((-0.001* (MPsi*MPsi) + u)*(-0.001* (MPsi*MPsi) + u))) + (2*token1*token2*token3*token4*token5*(s -  (MH*MH)))/( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH))) + (2000*token2*token3*token5*token6*token7*(-s +  (MH*MH))* (token4*token4))/((-1000*t +  (MChi*MChi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token2*token3*token5*token6*token7*(-s +  (MH*MH))* (token4*token4))/((-1000*u +  (MChi*MChi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token2*token3*token5*token6*token8*(-s +  (MH*MH))* (token4*token4))/(token10*(-1000*t +  (MPsi*MPsi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + (2000*token2*token3*token5*token6*token8*(-s +  (MH*MH))* (token4*token4))/(token10*(-1000*u +  (MPsi*MPsi))*( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH)))) + ( (token2*token2)* (token3*token3)* (token4*token4)* (token5*token5))/( (MH*MH*MH*MH) +  (s*s) +  (MH*MH)*(-2*s +  (WH*WH))));
}
